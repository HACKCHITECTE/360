...
$(document).ready(function($) {
    ...
    $('.hero-slider').slick({
        ...
        fade: true,          // Transition en fondu pour plus de classe
        cssEase: 'linear',
        arrows: false,       // On cache les flèches pour un look épuré
        dots: true           // On affiche les petits points de navigation
    });
});
